...
/**
 * First playable 3D foundation of Level 1.
 *
 * Temporary blockout world for 2x12.
 * Historical assets will be added later.
 */
public class Level1World implements Disposable {
    ...
    public Level1World() {
        ...
        environment.set(
            ColorAttribute.createDirectional(
                1f,
                1f,
                1f,
                1f
    ...
    private void createWorld() {
        ...
        ModelInstance classroom =
            new ModelInstance(classroomModel);

        classroom.transform.setToTranslation(
            -17f,
            2.5f,
            -3f
        );
        ...
        ModelInstance classroom2 =
            new ModelInstance(classroomModel);

        classroom2.transform.setToTranslation(
            17f,
            2.5f,
            -3f
        );
    ...
    public void render() {
        ...
        com.badlogic.gdx.Gdx.gl.glClear(
